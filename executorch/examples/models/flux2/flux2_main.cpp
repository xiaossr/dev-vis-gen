...
int main(int argc, char** argv) {
  ...
  int joint_dim = static_cast<int>(te_tensor.numel()) / seq_len;
  ...
  // Unpack (N, C) → (C, patch_h, patch_w)
  auto spatial = unpack_nc_to_chw(
      latents.data(), img_ids.data(), num_tokens, in_ch, patch_h, patch_w);
